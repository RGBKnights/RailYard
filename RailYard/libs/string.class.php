...
class String extends Object  {
	...
	public static function insert($str, $data, $options = array()) {
		...
		$data = (array)$data;
		if (empty($data)) {
			return ($options['clean']) ? String::clean_insert($str, $options) : $str;
		}
	 ...
	 * @see String::insert()
	 */
	public static function clean_insert($str, $options) {
		$clean = $options['clean'];
		if (!$clean) {
			return $str;
		}
		...
		switch ($clean['method']) {
			case 'html':
				...
				if ($clean['andText']) {
					...
					$str = String::clean_insert($str, $options);
				}
				break;
			case 'text':
				$clean = array_merge(array(
	...
	/**
	 * Object wrapper for sprintf to format text
	 * 
	 * @param string $format
	 * @param string $values
	 * @return string
