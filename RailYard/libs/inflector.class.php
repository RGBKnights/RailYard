 ...
 * Used for naming conventions throughout the framework.
 * 
 * @see			CakePHP - Inflector
 */
class Inflector extends Singleton {
	 ...
	 * @param boolean $reset If true, will unset default inflections for all new rules that are being defined in $rules.
	 * @access public
	 * @return void
	 * @static
	 */
	public static function rules($type, $rules, $reset = false) {
		$_this = Inflector::get_instance();
		$var = '_'.$type;
