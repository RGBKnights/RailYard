...
class Model
{
	 ...
	 *
	 * <code>
	 * YourModel::find('first', array('conditions' => array('name=?','Tito'), 'order' => 'name asc'))
	 ...
	 * <li><b>conditions:</b> A SQL fragment such as: 'id=1', array('id=1'), array('name=? and id=?','Tito',1), array('name IN(?)', array('Tito','Bob')), array('name' => 'Tito', 'id' => 1)</li>
